			...
			<div id="tabs">
				<ul>
					...
					<div id="course-title" style="width: 100%">
						Name of the Lecture will be here
						<div>
							<button type="button" class="btn btn-default navbar-btn">Rate
								Course</button>
							<button type="button" class="btn btn-default navbar-btn">Comment
								Course</button>
						</div>
					</div>
				</ul>
						...
						<div class="box">
							...
							<div class="col-lg-11">
								<div id="callout-navs-tabs-plugin"
									...
									<h5>
										<a href="#">Using navs for tab panels requires JavaScript
											tabs plugin</a>
									</h5>
								</div>

								used in this template are nested inbetween a normal Bootstrap
								row and the start of your column layout. The boxes will be
								full-width boxes, so if you want to make them smaller then you
